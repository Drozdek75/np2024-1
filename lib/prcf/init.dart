...
class _initState extends State<init> {
  ...
  GlobalKey detailKey = GlobalKey();
  double wdetail = 0, hdetail = 0;
  double xdet = 0, ydet = 0;
  bool _visMeter = false;

  /*
     
  */

  BehaviorSubject bhmacro = BehaviorSubject<int>();
  BehaviorSubject bhadd = BehaviorSubject<int>.seeded(-1);
  ...
  void initState() {
    ...
    // streamMacroSel = controller_sel_macro.stream;
  }
...
// Save the document.
    List<int> data = [];
    await document.save().then((val) => {data = val});
    print(data);
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: GestureDetector(
            onTap: () {
              BlocProvider.of<ProductBloc>(context).add(productLoad());
              BlocProvider.of<DashboardBloc>(context).add(PrinterDiscovered());
              savePdf();
            },
            child: Image(
                          ...
                          children: [
                            ...
                            Visibility(
                              ...
                              child: Container(
                                ...
                                color: const Color.fromARGB(255, 255, 255, 255),
                                height:
                                    MediaQuery.of(context).size.height - 423,
                                child: Row(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Expanded(
                                                            ...
                                                            GestureDetector(
                                                              ...
                                                              child: Container(
                                                                /*  color: e.progressivo ==
                                                                        bhmacro
                                                                            .valueOrNull
                                                                    ? const Color.fromARGB(255, 181, 206, 235)
                                                                    : const Color
                                                                        .fromARGB(
                                                                        0,
                                                                        134,
                                                                ...
                                                                child: Row(
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Expanded(
                                                                        child: Container(
                                                                            child:
                                                                                Text('${(e.price * e.qt).toStringAsFixed(2)}')))
                                                                  ],
                                                                ),
                                                              ),
                                                            ),
                                                                ...
                                                                children:
                                                                  ...
                                                                  (odd) {
                                                                    return GestureDetector(
                                                                      ...
                                                                      child:
                                                                          Container(
                                                                        color: (e.progressivo == bhmacro.value && odd.cod_product == bhadd.value)
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            Expanded(
                                                                              child: Text(
                                                                                ' ${odd.type == 1 ? ' + ' : ' - '} ${ListIngredients.findByCod(odd.cod_product!)?.name} ',
                                                                                style: GoogleFonts.lato(fontSize: 15, color: const Color.fromARGB(255, 4, 197, 68)),
                                                                              ),
                                                                            ),
                                                                          ],
                                                                        ),
                                                                  ...
                                                                  children: [
                                                                    Expanded(
                                                                      child:
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          '${BlocProvider.of<DetailOrderBloc>(context).getTotale(e.progressivo).toStringAsFixed(2)}',
                                                                          textAlign:
                                                                              TextAlign.end,
                            ...
                            Container(
                              ...
                              child: Row(
                                children: [
                                  GestureDetector(
                                    onTap: () {
                                      controllers[select_controller].text +=
                                          '7';
                                    },
                                    child: Container(
                                      decoration: BoxDecoration(
                        ...
                        children: [
                          Expanded(
                            child: Container(
                              ...
                              padding:
                                  EdgeInsets.only(top: 4, bottom: 4, left: 10),
                              height: 40,
                              child: Row(
                              ...
                              child: Row(spacing: 1, children: [
                                ...
                                Container(
                                  ...
                                  child: Center(
                                    ...
                                    color:
                                        const Color.fromARGB(255, 230, 243, 89),
                                  )),
                                ),
                                Expanded(
                                    child: Container(
                                        ...
                                        child: Container(
                                          ...
                                          child: TextButton(
                                              onPressed: () {
                                                ...
                                                print(obj.size);
                                                setState(() {
                                                  wdetail = obj.size.width;
                                                  hdetail = obj.size.height;
                                                  _visMeter = true;
                                                  xdet = pos.dx;
                                                  ydet = pos.dy - 50;
                                                });
  ...
  Future<void> _dialogBuilder(BuildContext context) {
    return showDialog<void>(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: const Text('Errore di procedura'),
          content: const Text(
            'Stai cercando di togliere un ingrediente non contenuto nella pizza selezionata...',
          ),
          actions: <Widget>[
            TextButton(
